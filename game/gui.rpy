...
define gui.dialogue_ypos = 21

## The maximum width of dialogue text, in pixels.
define gui.dialogue_width = 310
...
define gui.choice_button_width = 329
define gui.choice_button_height = None
define gui.choice_button_tile = False
define gui.choice_button_borders = Borders(42, 3, 42, 3)
...
define gui.slot_button_width = 115
define gui.slot_button_height = 86
...
define config.thumbnail_width = 107
...
define gui.skip_frame_borders = Borders(7, 3, 21, 3)
...
define gui.history_height = 59

## The position, width, and alignment of the label giving the name of the
## speaking character.
define gui.history_name_xpos = 65
define gui.history_name_ypos = 0
define gui.history_name_width = 65
define gui.history_name_xalign = 1.0

## The position, width, and alignment of the dialogue text.
define gui.history_text_xpos = 71
define gui.history_text_ypos = 1
define gui.history_text_width = 309
...
## The position, width, and alignment of the label giving the name of the
## speaking character.
define gui.nvl_name_xpos = 180
define gui.nvl_name_ypos = 0
define gui.nvl_name_width = 63
define gui.nvl_name_xalign = 1.0

## The position, width, and alignment of the dialogue text.
define gui.nvl_text_xpos = 188
define gui.nvl_text_ypos = 4
define gui.nvl_text_width = 246
...
define gui.nvl_thought_width = 325
define gui.nvl_thought_xalign = 0.0

## The position of nvl menu_buttons.
define gui.nvl_button_xpos = 188
...
init python:
    ...
    if renpy.variant("small"):
        ...
        gui.textbox_height = 100
        gui.name_xpos = 34
        gui.dialogue_xpos = 38
        gui.dialogue_width = 459

        ## Change the size and spacing of various things.
        gui.slider_size = 15

        gui.choice_button_width = 517
        gui.choice_button_text_size = 13

        gui.navigation_spacing = 9
        gui.pref_button_spacing = 5

        gui.history_height = 80
        gui.history_text_width = 288
        ...
        gui.nvl_name_width = 128
        gui.nvl_name_xpos = 136

        gui.nvl_text_width = 382
        gui.nvl_text_xpos = 144
        gui.nvl_text_ypos = 3

        gui.nvl_thought_width = 517
        gui.nvl_thought_xpos = 9

        gui.nvl_button_width = 517
